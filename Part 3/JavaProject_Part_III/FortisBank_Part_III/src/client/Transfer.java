...
public class Transfer extends JFrame {
	...
	public Transfer() {
		...
		// button sender search is used to search the details of sender account
		...
		// button receiver search is used to search the details of receiver account
		...
		// button transfer is used to update the balance from both the tables.
				...
				try
				{
					...
					else
					{
						try {
							...
							{
								SavingAccountDB.withdraw(senderAccountNo,(senderBalance-amount));
								senderStatus = true;
							}
							
							
							if(receiverTableName.equals("CheckingAccount"))
							{
								CheckingAccountDB.withdraw(receiverAccountNo,(receiverBalance+amount));
								receiverStatus = true;
							}
							if(receiverTableName.equals("CreditAccount"))
							{
								CreditAccountDB.withdraw(receiverAccountNo,(receiverBalance+amount));
								receiverStatus = true;
							}
							if(receiverTableName.equals("SavingAccount"))
							{
								SavingAccountDB.withdraw(receiverAccountNo,(receiverBalance+amount));
								receiverStatus = true;
							}
