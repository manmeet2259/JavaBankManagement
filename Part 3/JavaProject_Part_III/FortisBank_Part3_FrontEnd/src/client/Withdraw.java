...
public class Withdraw extends JFrame {
	...
	public Withdraw() {
		...
		// button search is user to search the account of a user to withdraw the ammount
		...
		// button withdraw is used to update the balance of the account
			...
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					try {
						...
						{
							CheckingAccountDB.withdraw(accountNo, balance);
							status = true;
						}
						if(tableName.equals("CreditAccount"))
						{
							CreditAccountDB.withdraw(accountNo, balance);
							status = true;
						}
